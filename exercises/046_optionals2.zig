...
fn linkElephants(e1: ?*Elephant, e2: ?*Elephant) void {
    // The commented line seemed to be changed to the uncommented one below in this patch:
    // https://codeberg.org/ziglings/exercises/commit/3baf0ae657a80e8a63e96924560a3908b6ea6a9d
    //
    // ...But it doesn't appear in the code in the code for some reason.
    // e1.?.*.tail = e2.?;
    e1.?.tail = e2;
}
